...
/*This is how elements should be added to the array list*/ obj1.add("Ajeet");
obj1.add("Harry"); 
obj1.add("Chaitanya"); obj1.add("Steve");
obj1.add("Anuj"); 
/* Displaying array list elements
/* System.out.println("\nCurrently the array list obj1 has following elements:"+obj1); 
/*Append element at the end*/ obj1.add("Babu");
obj1.add("Kamal"); 
/*Append collection element to ArrayList*/ ArrayList<String> obj2 = new ArrayList<String>();
obj2.add("Alice"); 
obj2.add("Bob"); 
obj2.add("Raj"); 
...
/*Add element at the given index*/ obj1.add(0, "Rahul");
obj1.add(1, "Justin"); 
...
obj1.remove("Chaitanya"); obj1.remove("Harry"); 
...
System.out.println("\nEnter the letter to display all the string start with given letter:"); search=input.nextLine(); 
